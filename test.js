    ...
    var yandexMaps = {
        ...
        createPlacemarks: function (points, map) {
            ...
            for (const point of points) {
                var pos = point.code.lastIndexOf("_");
                var search_str = point.code.substring(0, pos);
                // !== _1, _2, ...
                if (pos !== point.code.length - 2 || !unique_points.includes(search_str)) {
                    ...
                    const balloonContentBody =
                        '<h3 style="font-size: 1em;font-weight: bold;margin-bottom: 0.5em;">' + point.title + '</h3>' +
                    ...
                    objectManager.add({
                        ...
                        properties: {
                            ...
                            balloonContentFooter: '<a href=# data-placemarkid="' + point.code + '" class="list_item btn btn-success text-light">Забрать отсюда</a>',
                        },
                        options: {
